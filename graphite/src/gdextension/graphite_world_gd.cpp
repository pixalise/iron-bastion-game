...
void GraphiteWorld::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("is_navigation_grid_configured"),
	                     &GraphiteWorld::is_navigation_grid_configured);
	ClassDB::bind_method(D_METHOD("get_navigation_width"), &GraphiteWorld::get_navigation_width);
	ClassDB::bind_method(D_METHOD("get_navigation_height"), &GraphiteWorld::get_navigation_height);
	ClassDB::bind_method(D_METHOD("get_navigation_cell_size"),
	                     &GraphiteWorld::get_navigation_cell_size);
	ClassDB::bind_method(D_METHOD("get_navigation_cell_count"),
	                     &GraphiteWorld::get_navigation_cell_count);
	ClassDB::bind_method(D_METHOD("get_navigation_cells"), &GraphiteWorld::get_navigation_cells);
}
...
void GraphiteWorld::set_navigation_cells(const PackedByteArray& cells) {
	ERR_FAIL_COND_MSG(!is_navigation_grid_configured(),
