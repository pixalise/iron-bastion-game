...
const VALUES := {
	...
	[
		"Rifle Man",
		"The unit does <style:PHYSICAL_DAMAGE><tooltip:PHYSICAL_DAMAGE_TYPE> <icon:PHYSICAL_DAMAGE/> {float:physical_damage} </tooltip></style> points of<br/>damage per shot.",
		"Physical damage",
		"<icon:PHYSICAL_DAMAGE/> <style:PHYSICAL_DAMAGE> Damage coming</style> from ballistic, blunt force and<br/>other variant of physical damage",
		"Old Revolver",
		"<style:QUOTE>A weapon from the olden era</style>\nAnd old revolver with a leather handle.",
		"",
		"Waxed string ",
		"<style:QUOTE>Old ways. New prey</style>\nA simple hemp bowstring treated with beeswax.",
		"Hunting Arrows",
		"<style:QUOTE>Old ways. New prey</style>\nArrows fitted with broad hunting tips. - pircing Made for beasts, proven on worse",
		"",
		"",
		"<style:QUOTE>Everything has a weakness.</style>\nNarrow steel-tipped arrows built to punch through armor.",
		"Piercing Arrows",
		"",
		"Fire Arrows",
		"<style:QUOTE>The dead return. Ash does not.</style>\nArrows wrapped with alcohol-soaked cloth.",
		"",
		"Reinforced Bow",
		"<style:QUOTE>It only needs to outlast us.</style>\nReinforced with mixed materials to hold greater tension without breaking.",
		"",
		"Old Friend",
		"<style:QUOTE>Come on, old friend. One more hunt.</style>\nA battle-worn bow that endures impossible tension.",
		...
		"Makeshift Armor",
		"<style:QUOTE>It does not need to look good. It only needs to stop the bite</style>\nScrap metal and thick fabric tied together into crude protection.",
		...
		"Pocket Watch",
		"<style:QUOTE>It stopped the day the appoclyps started</style>\nA scratched pocket watch that still keeps time.",
		...
		"Old Medal",
		"<style:QUOTE>They said you were brave, i just wanted you home.</style>\nA tarnished medal awarded for a forgotten act of courage.",
		...
		"Deck of Cards",
		"<style:QUOTE>We always said we would finish the game tomorrow.</style>\nA worn deck missing several cards.",
		...
		"Guitar",
		"<style:QUOTE>For a moment, everything feels normal again.</style>\nA worn acoustic guitar with a warm, uneven sound.",
		...
		"Cigarettes\n",
		"<style:QUOTE>You said you would quit when things got better.</style>\nA dry pack of cigarettes saved for difficult nights.",
