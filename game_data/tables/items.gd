...
const SLUGS := [
	"OLD_REVOLVER", "WAX_STRING", "HUNTING_ARROWS", "BOW_OLD_FRIEND", "TEDDY_BEAR", "MATCH_BOX"
]
const NAME := [
	...
	ChiselLocalization.Id.ITEM_TEDDY_BEAR_NAME,
	ChiselLocalization.Id.ITEM_USED_MATCHBOX_NAME
]
const DESCRIPTION := [
	...
	ChiselLocalization.Id.ITEM_TEDDY_BEAR_DESCRIPTION,
	ChiselLocalization.Id.ITEM_USED_MATCHBOX_DESCRIPTION
]
const STORY := [
	...
	ChiselLocalization.Id.ITEM_TEDDY_BEAR_STORY,
	ChiselLocalization.Id.ITEM_USED_MATCHBOX_STORY
]
const PORTRAIT := [
	...
	ChiselAssets.Id.PHYSICAL_DAMAGE,
	ChiselAssets.Id.ITEM_TEDDY_BEAR,
	ChiselAssets.Id.ITEM_MATCHBOX
]
const PRICE := [0, 20, 30, 800, 25, 30]
const MODIFIERS := [
	...
	"Increases moral and damage for 5%",
	"Increases fire damage by 5%"
]
const RARITY := ["COMMON", "COMMON", "COMMON", "COMMON", "COMMON", "COMMON"]
const ALLOWS_MULTIPLE := [true, true, true, false, true, true]
